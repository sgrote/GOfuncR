...
The gene ontology graph (obtained from [geneontology](http://archive.geneontology.org/lite/latest/), last modified on 07-Oct-2019), is integrated in the package.
