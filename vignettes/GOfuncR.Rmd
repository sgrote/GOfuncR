...
Instead of using gene-coordinates from bioconductor packages, one can also provide custom gene-coordinates directly as a dataframe wih four columns: gene, chromosome, start, end (parameter `gene_coords`).
