...
GO-annotations are obtained from *OrganismDb* or *OrgDb* packages (`r Biocpkg('Homo.sapiens')` by default). The gene ontology graph (obtained from [geneontology](http://archive.geneontology.org/latest-termdb/), last modified on 12-Oct-2017), is integrated in the package.   
