...
The gene ontology graph (obtained from [geneontology](http://current.geneontology.org/ontology/), release date 07-Oct-2019), is integrated in the package.
...
A default GO-graph (obtained from [geneontology](http://current.geneontology.org/ontology/), release date 07-Oct-2019), is integrated in the package.
